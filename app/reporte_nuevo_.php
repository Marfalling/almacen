...
{
    error_log("❌ Error: No se encontró id_brigada para el usuario $id_usuario en reporte_nuevo_.php");
    echo json_encode([
        "status" => "error",
...
{
    error_log("❌ Error: No se encontró cantidad de reportes archivados para num $num y brigada $id_brigada en reporte_nuevo_.php");
    $cantidad = 0;
} 
else 
{
