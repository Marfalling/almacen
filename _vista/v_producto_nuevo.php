            ...
            <div class="col-md-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" action="producto_nuevo.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <input type="text" name="nom_producto" class="form-control" placeholder="Nombre del producto" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <textarea name="det_producto" class="form-control" rows="3" placeholder="Detalle del producto"></textarea>
                                </div>
                            </div>
