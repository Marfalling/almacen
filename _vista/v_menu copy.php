<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
      <a href="#" class="site_title"><span>TJ H2B</span></a>
    </div>
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li>
            ...
            <ul class="nav child_menu">
              ...
              <li>
                ...
                <ul class="nav child_menu">
                  <li><a href="usuarios_mostrar.php">Listado de usuarios</a></li>
                  <li><a href="usuarios_nuevo.php">Nuevo usuario</a></li>
                </ul>
              </li>
          ...
          <li>
            <a href="auditoria_mostrar.php"><i class="fa fa-clipboard-list"></i> Auditoria</a>
          </li>
