    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Datos de Personal <small></small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br>
                        <form class="form-horizontal form-label-left" action="personal_nuevo.php" method="post">
                            <div class="form-group row ">
                                <label class="control-label col-md-3 col-sm-3 ">Nombres <span class="text-danger">*</span> :</label>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" name="ape" class="form-control" placeholder="Apellido" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" name="dni" class="form-control" placeholder="Documento de identidad" required="required">
                                </div>
                            </div>

                            <div class="form-group row ">
                                <label class="control-label col-md-3 col-sm-3 ">Celular <span class="text-danger">*</span> :</label>
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" name="tel" class="form-control" placeholder="Celular" required="required">
                                </div>
                            </div>
