                        ...
                        <form class="form-horizontal form-label-left" action="pedidos_editar.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    ...
                                    <input type="hidden" id="id_producto_tipo_hidden" value="<?php echo isset($pedido['id_producto_tipo']) ? $pedido['id_producto_tipo'] : ''; ?>">
                                </div>
                            </div>
                            ...
                            <!-- Centro de Costos - SOLO LECTURA PARA SOLICITANTE -->
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-3">Centro de Costos <span class="text-danger">*</span>:</label>
                                <div class="col-md-9 col-sm-9">
                                    <?php 
                                    // Buscar el nombre del centro de costo del pedido
                                    $nombre_centro_costo = 'N/A';
                                    foreach ($centros_costo as $centro) {
                                        if ($centro['id_centro_costo'] == $pedido['id_centro_costo']) {
                                            $nombre_centro_costo = $centro['nom_centro_costo'];
                                            break;
                                        }
                                    }
                                    ?>
                                    <input type="text" class="form-control" 
                                        value="<?php echo htmlspecialchars($nombre_centro_costo); ?>" 
                                        readonly>
                                    <input type="hidden" name="id_centro_costo" 
                                        value="<?php echo $pedido['id_centro_costo']; ?>">
                                </div>
                            </div>
                            ...
                            <div id="contenedor-materiales">
                                ...
                                <div class="material-item border p-3 mb-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="descripcion[]" class="form-control" value="<?php echo $detalle['prod_pedido_detalle']; ?>" readonly required>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-12" id="col-centros-<?php echo $contador_material; ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function esTipoServicio(idTipo) {
        ...
        // En editar, el tipo de servicio es típicamente ID 2
        return idTipo === '2';
    }
    
    // Verificar estado inicial basado en el tipo de pedido actual
    if (tipoProductoInput && tipoProductoInput.value) {
        const esServicio = esTipoServicio(tipoProductoInput.value);
        toggleCamposPersonal(esServicio);
        
        // Inicializar Select2 de personal si es servicio
        if (esServicio) {
