                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form method="get" action="compras_mostrar.php" class="form-inline mb-3">
                            ...
                            <button type="button" class="btn btn-secondary mb-2" onclick="window.location.href='compras_mostrar.php'"><i class="bi bi-eraser"></i> Limpiar</button>
                       </form>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($compra['est_compra'] != 0) { ?>
                                        <button class="btn btn-sm btn-outline-secondary" onclick="EliminarDocumento(<?php echo $doc['id_doc']; ?>)">
