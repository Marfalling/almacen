                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" action="ingresos_directo_nuevo.php" method="post" id="form-ingreso-directo" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-3 col-sm-3">Centro de Costo del Registrador:</label>
                                    <div class="col-md-9 col-sm-9">
                                        <?php if ($centro_costo_usuario) { ?>
                                            <input type="text" class="form-control" 
                                                value="<?php echo htmlspecialchars($centro_costo_usuario['nom_centro_costo']); ?>" 
                                                readonly>
                                            <input type="hidden" name="id_centro_costo_registrador" 
                                                value="<?php echo $centro_costo_usuario['id_centro_costo']; ?>">
                                            <small class="form-text text-muted">
                                                <i class="fa fa-info-circle"></i> Este es tu centro de costo asignado.
                                            </small>
                                        <?php } else { ?>
                                            <input type="text" class="form-control" 
                                            ...
                                            <small class="text-danger">
                                                <i class="fa fa-exclamation-triangle"></i> No tienes un centro de costo asignado. Contacta con el administrador.
                                            </small>
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <!--  CONTENEDOR DE PRODUCTOS (SIN LOS BOTONES DENTRO) -->
                                    ...
                                    <div class="producto-item border p-3 mb-3" style="background-color: #f8f9fa;">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                                ...
                                                <select name="centros_costo[0][]" class="form-control select2-centros-costo-ingreso" multiple required>
                                ...
                                <!-- 🔹 BOTÓN AGREGAR FUERA DEL CONTENEDOR -->
                                ...
                                <!-- 🔹 BOTONES DE ACCIÓN FUERA DEL CONTENEDOR -->
                                <div class="form-group">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('agregar-producto').addEventListener('click', function() {
            ...
            const materialOriginal = contenedor.querySelector('.producto-item');
            ...
            if (materialOriginal) {
                ...
                const selectsOriginales = materialOriginal.querySelectorAll(
                    'select.select2-centros-costo-ingreso'
                );
                ...
                const nuevoProducto = materialOriginal.cloneNode(true);
                ...
                // 5. LIMPIAR campos del NUEVO producto
                ...
                // 6. ACTUALIZAR name del select de centros de costo
                const selectCentrosNuevo = nuevoProducto.querySelector('select.select2-centros-costo-ingreso');
                if (selectCentrosNuevo) {
                    selectCentrosNuevo.name = `centros_costo[${contadorProductos}][]`;
                    
                    // Limpiar Select2 del clonado
                    $(selectCentrosNuevo).removeClass('select2-hidden-accessible');
                    const select2Container = selectCentrosNuevo.nextElementSibling;
                    if (select2Container && select2Container.classList.contains('select2')) {
                        select2Container.remove();
                    }
                    
                    // Limpiar opciones seleccionadas
                    Array.from(selectCentrosNuevo.options).forEach(option => {
                        option.selected = false;
                    });
                    selectCentrosNuevo.selectedIndex = -1;
                }
