...
function init_DataTables_Extra(name_datatable) {
    if (console.log("run_datatables"),
        void 0 !== $.fn.DataTable) {
        console.log("init_DataTables");
        TableManageButtons = function () {
            ...
            $("#".concat(name_datatable)).dataTable(),
            $("#datatable-keytable").DataTable({
                keys: !0
            }),
            $("#datatable-responsive").DataTable(),
...
function init_morris_charts() {
    "undefined" != typeof Morris && (console.log("init_morris_charts"),
        $("#graph_bar").length && Morris.Bar({
            ...
            data: data_ingresos,
            xkey: "period",
            ykeys: ["suma_pre_seguimiento"],
            labels: ["Suma de Seguimiento"],
            barRatio: .4,
            barColors: ["#26B99A"],
            xLabelAngle: 35,
            hideHover: "auto",
        ...
        $("#graph_area").length && Morris.Area({
            element: "graph_area",
            data: data_registros_muestras,
            xkey: "period",
            ykeys: ["cantidad"],
            lineColors: ["#26B99A"],
            labels: ["Cantidad de Registros"],
            pointSize: 2,
            hideHover: "auto",
            resize: true
        }),
        $("#graph_donut").length && Morris.Donut({
            element: "graph_donut",
            data: data_equipos_tipo,
            colors: colors_equipos_tipo,
            formatter: function (e) {
                return e
            },
            resize: !0
        }),
        $("#user_donut").length && Morris.Donut({
            element: "user_donut",
            data: data_usuarios_tipo,
            colors: colors_usuarios_tipo,
            formatter: function (e) {
                return e
            },
            resize: !0
